                ...
                <div className="relative bg-cover bg-center h-screen pt-10">
                    ...
                    <div className="relative z-4 flex flex-col items-center justify-center h-3/4 text-black text-center">
                        ...
                        <div className="flex flex-row max-sm:flex-col text-xl">
                            <img className="h-[500px] w-[350px] mt-5 max-sm:w-auto sm:w-[300px] lg:w-auto" src="assets/NewFlyer.png" alt="Flyer" />
                            <div className="bg-gray-300 text-black mt-5 rounded-md px-5 pb-5 mx-10 h-[500px] max-sm:items-center max-sm:h-auto max-sm:w-[350px] sm:text-[16px] sm:py-40 lg:text-xl">
